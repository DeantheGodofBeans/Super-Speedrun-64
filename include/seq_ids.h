...
#define SEQ_MENU_GAME_OVER (SEQ_TITLE_SCREEN | SEQ_VARIATION)

enum SeqId {
    SEQ_SOUND_PLAYER,  // 0x00
    SEQ_EVENT_CUTSCENE_COLLECT_STAR,  // 0x01
    SEQ_TITLE_SCREEN,  // 0x02
    ...
    SEQ_QUESTION_MARK,  // 0x23
    SEQ_MARIO_KART_WII_OPTIONS,  // 0x24
    SEQ_COUNT,
};
